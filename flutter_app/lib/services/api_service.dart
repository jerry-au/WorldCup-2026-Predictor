...
class ApiService {
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      onResponse: (response, handler) {
        ...
        if (response.data == null) {
          debugPrint('[API] Warning: null response for ${response.requestOptions.uri}');
        }
  ...
  Future<dynamic> predictMatch({
    ...
    try {
      ...
      debugPrint('[API] predictMatch response status: ${resp.statusCode}, dataType: ${resp.data.runtimeType}');
      return resp.data;
    } catch (e, st) {
